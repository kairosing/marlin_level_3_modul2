                        ...
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <?php if ($auth->hasRole(\Delight\Auth\Role::ADMIN) || $auth->getUserId() == $user['user_id']): ?>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="/delete/<?=$user['user_id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <div class="d-flex flex-row">
                                <a href="https://vk.com/<?php echo $user['vk'];?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                    <i class="fab fa-vk"></i>
                                </a>
                                <a href="https://t.me/<?php echo $user['telegram'];?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                    <i class="fab fa-telegram"></i>
                                </a>
                                <a href="https://www.instagram.com/<?php echo $user['instagram'];?>" class="mr-2 fs-xxl" style="color:#E1306C">
